...
class Calculator:
    ...
    def __init__(self):
        ...
        self.btn_color_primary = "black"
        self.btn_color_secondary1 = "orange"
        self.btn_color_secondary2 = "red"
        self.fg = "white"
        ...
        self.btn0 = Button(self.window, text='0', relief=GROOVE, font=self.font_digit, bg=self.btn_color_primary, fg=self.fg)
        self.btn1 = Button(self.window, text='1', relief=GROOVE, font=self.font_digit, bg=self.btn_color_primary, fg=self.fg)
        self.btn2 = Button(self.window, text='2', relief=GROOVE, font=self.font_digit, bg=self.btn_color_primary, fg=self.fg)
        self.btn3 = Button(self.window, text='3', relief=GROOVE, font=self.font_digit, bg=self.btn_color_primary, fg=self.fg)
        self.btn4 = Button(self.window, text='4', relief=GROOVE, font=self.font_digit, bg=self.btn_color_primary, fg=self.fg)
        self.btn5 = Button(self.window, text='5', relief=GROOVE, font=self.font_digit, bg=self.btn_color_primary, fg=self.fg)
        self.btn6 = Button(self.window, text='6', relief=GROOVE, font=self.font_digit, bg=self.btn_color_primary, fg=self.fg)
        self.btn7 = Button(self.window, text='7', relief=GROOVE, font=self.font_digit, bg=self.btn_color_primary, fg=self.fg)
        self.btn8 = Button(self.window, text='8', relief=GROOVE, font=self.font_digit, bg=self.btn_color_primary, fg=self.fg)
        self.btn9 = Button(self.window, text='9', relief=GROOVE, font=self.font_digit, bg=self.btn_color_primary, fg=self.fg)

        self.btnAdd = Button(self.window, text='+', relief=GROOVE, font=self.font_digit, bg=self.btn_color_primary, fg=self.fg)
        self.btnSub = Button(self.window, text='-', relief=GROOVE, font=self.font_digit, bg=self.btn_color_primary, fg=self.fg)
        self.btnMul = Button(self.window, text='x', relief=GROOVE, font=self.font_digit, bg=self.btn_color_primary, fg=self.fg)
        self.btnDiv = Button(self.window, text='÷', relief=GROOVE, font=self.font_digit, bg=self.btn_color_primary, fg=self.fg)
        self.btnEq = Button(self.window, text='=', relief=GROOVE, font=self.font_digit, bg=self.btn_color_secondary1, fg=self.fg)
        self.btnDot = Button(self.window, text='.', relief=GROOVE, font=self.font_digit, bg=self.btn_color_primary, fg=self.fg)

        self.btnAC = Button(self.window, text='A', relief=GROOVE, font=self.font_digit, bg=self.btn_color_secondary2)
        self.btnC = Button(self.window, text='C', relief=GROOVE, font=self.font_digit, bg=self.btn_color_primary, fg=self.fg)
